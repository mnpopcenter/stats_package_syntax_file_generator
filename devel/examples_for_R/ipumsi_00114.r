...
usa_00001 <- read.fwf("ipumsi_00114.dat",
	widths=c(4,10,12,2,1,4,10,3,12,1,4,3,1,1,3,1,1,1,1,1,3,3,3,3,1),
	colClasses="numeric",
	col.names=c("SAMPLE","SERIAL","WTHH","GQ","URBAN","SAMPLEP","SERIALP","PERNUM","WTPER","RELATE","RELATED","AGE","SEX","MARST","MARSTD","PA70A402","PA60A402","CR73A401","CR84A401","MARST_HEAD","MARSTD_HEAD","MARSTD_MOM","MARSTD_POP","MARSTD_SP","CR73A401_HEAD"),
	header=FALSE)
attach(usa_00001)
